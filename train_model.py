...
# %%
if args.type == 'all':
    save_path = '/mnt/hdd/spow12/work/fundus/fundus_paper/model_weights/disease_classification_single/model_all/'
    use_csv = csv
elif args.type == 'tilt':
    save_path = '/mnt/hdd/spow12/work/fundus/fundus_paper/model_weights/disease_classification_single/model_tilt/'
    use_csv = csv_tilt
elif args.type == 'non_tilt':
    save_path = '/mnt/hdd/spow12/work/fundus/fundus_paper/model_weights/disease_classification_single/model_non_tilt/'
